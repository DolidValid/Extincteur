...
<body class=" h-100 bg-dark" >
    <header>
        <div class="navbar navbar-expand-md bg-dark navbar-dark text-white fixed-top">
            <div class="container">
                 <a href="" class="navbar-brand text-danger"><span class="text-light">GESTION </span>EXTINCTEUR</a> 
    ...
    <div class="container">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 fixed border-top">
            ...
            <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
              ...
              <li class="ms-3"><a class="text-muted" href="https://www.facebook.com/walid.d.valid "><svg class="bi" width="24" height="24"><use xlink:href="#facebook"/></svg></a></li>
            </ul>
          </footer>
